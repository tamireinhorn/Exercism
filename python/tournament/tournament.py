...
def format_result(team, team_dict):
    return f'{team: <31}| {team_dict[team]["MP"]:>2} | {team_dict[team]["W"]:>2} | {team_dict[team]["D"]:>2} | {team_dict[team]["L"]: >2} | {team_dict[team]["P"]: >2}'
...
def tally(rows: list):
    ...
    #To sort the results by score REVERSED and then break ties, you sort a list by alphabet, 
    #Then, since it has partially the order you need, you apply the score sort.
